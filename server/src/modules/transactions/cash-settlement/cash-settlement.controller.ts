...
export class CashSettlementController {
  ...
  async getCashSettlement(
    ...
    return this.cashSettlementService.getCashSettlementService(paperId);
  }

  @Post(':paperId/route-expenses')
  @Roles('EMPLOYEE')
  async saveRouteExpenses(
    ...
    return this.cashSettlementService.saveRouteExpensesService(paperId, dto);
  }

  @Post(':paperId/route-denominations')
  @Roles('EMPLOYEE')
  async saveRouteDenominations(
    ...
    return this.cashSettlementService.saveRouteDenominationsService(
      paperId,
      dto,
    );
  }

  @Post(':paperId/direct-collections')
  @Roles('EMPLOYEE')
  async saveDirectCollections(
    ...
    return this.cashSettlementService.saveDirectCollectionsService(
      paperId,
      dto,
    );
  }

  @Post(':paperId/bank-deposits')
  @Roles('EMPLOYEE')
  async saveBankDeposits(
    ...
    return this.cashSettlementService.saveBankDepositsService(paperId, dto);
  }
}
