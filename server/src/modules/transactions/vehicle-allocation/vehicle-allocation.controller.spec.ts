...
describe('VehicleAllocationController', () => {
    ...
    describe('getVehicleAllocations', () => {
        ...
        it('propagates service errors', async () => {
            ...
            vehicleAllocationService.getVehicleAllocations.mockRejectedValue(
                error,
            );

            await expect(
                controller.getVehicleAllocations(
                    999,
                    DeliverySession.MORNING,
                ),
            ).rejects.toBe(error);
    ...
    describe('saveVehicleAllocations', () => {
        it('passes paperId and dto to the service', async () => {
            ...
            const result = await controller.saveVehicleAllocations(
                123,
                dto as never,
            );
        ...
        it('passes expectedUpdatedAt without modifying the dto', async () => {
            ...
            await controller.saveVehicleAllocations(
                456,
                dto as never,
            );
            ...
            expect(dto.expectedUpdatedAt).toBe(
        ...
        it('propagates service errors', async () => {
            ...
            vehicleAllocationService.saveVehicleAllocations.mockRejectedValue(
                error,
            );
            ...
            await expect(
                controller.saveVehicleAllocations(
                    123,
                    dto as never,
                ),
            ).rejects.toBe(error);
