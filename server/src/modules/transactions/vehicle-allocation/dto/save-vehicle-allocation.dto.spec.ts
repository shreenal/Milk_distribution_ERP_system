...
describe('SaveVehicleAllocationDto', () => {
  ...
  describe('allocations', () => {
    it('should reject a non-array allocations value', async () => {
      ...
      expect(errors.some((error) => error.property === 'allocations')).toBe(
        true,
      );
    });
  ...
  describe('assignments', () => {
    it('should reject a non-array assignments value', async () => {
      ...
      expect(errors.some((error) => error.property === 'assignments')).toBe(
        true,
      );
    });
  ...
  it('should accept both supply categories', async () => {
    for (const category of [SupplyCategory.MILK, SupplyCategory.NON_MILK]) {
      const dto = createDto({
        allocations: [
          {
            ...validAllocation,
