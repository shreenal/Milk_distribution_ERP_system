...
import { VehicleAllocationService }
    from './vehicle-allocation.service.js';
...
export class VehicleAllocationController {
    ...
    constructor(
        ...
        private readonly vehicleAllocationService:
