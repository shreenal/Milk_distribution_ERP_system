...
import { ProductColumnNode, ProductColumnsBuilder } from '../../common/builders/product-columns.builder.js';
import { Product, TransferGrid, TransferSourceItem, TransferSummaryBuilder } from '../../types/distributor-transfer.types.js';
...
export class DistributorTransferBuilder {
    ...
    buildTransferSummary(sourceItems: TransferSourceItem[]): TransferSummaryBuilder[] {
    ...
    buildTransferGrids(
        ...
        for (const summary of summaries) {
            ...
            const includePackagingType =
                firstProduct.master_product_group.category ===
